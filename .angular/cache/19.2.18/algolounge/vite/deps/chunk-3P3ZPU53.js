...
var RangeSet = class _RangeSet {
  ...
  */
  update(updateSpec) {
    ...
    if (this.isEmpty) return add2.length ? _RangeSet.of(add2) : this;
  ...
  */
  static join(sets) {
    ...
    for (let i = sets.length - 2; i >= 0; i--) {
      for (let layer2 = sets[i]; layer2 != _RangeSet.empty; layer2 = layer2.nextLayer) result = new _RangeSet(layer2.chunkPos, layer2.chunk, result, Math.max(layer2.maxPoint, result.maxPoint));
    }
    return result;
  }
};
...
//# sourceMappingURL=chunk-3P3ZPU53.js.map
