...
import {
  ...
  TimesCircleIcon,
  TimesIcon
} from "./chunk-2PDWLGKY.js";
import {
  BaseComponent
} from "./chunk-ZGQ77YZY.js";
import {
  BaseStyle,
  PrimeNG
} from "./chunk-WBOMC3D4.js";
import {
  OverlayService,
  PrimeTemplate,
  SharedModule,
...
var Chip = class _Chip extends BaseComponent {
  ...
  containerClass() {
    let classes4 = "p-chip p-component";
    if (this.styleClass) {
...
var AutoComplete = class _AutoComplete extends BaseComponent {
  ...
  handleDropdownClick(event) {
    ...
    if (this.overlayVisible) {
      ...
      focus(this.inputEL.nativeElement);
      query2 = this.inputEL.nativeElement.value;
      if (this.dropdownMode === "blank") this.search(event, "", "dropdown");
      else if (this.dropdownMode === "current") this.search(event, query2, "dropdown");
    }
  ...
  onInput(event) {
    if (this.typeahead) {
      ...
      if (this.maxlength !== null) {
        query2 = query2.split("").slice(0, this.maxlength).join("");
      }
      if (!this.multiple && !this.forceSelection) {
        this.updateModel(query2);
      }
      if (query2.length === 0 && !this.multiple) {
        this.onClear.emit();
        setTimeout(() => {
          this.hide();
        }, this.delay / 2);
      } else {
        if (query2.length >= this.minLength) {
          this.focusedOptionIndex.set(-1);
          this.searchTimeout = setTimeout(() => {
            this.search(event, query2, "input");
          }, this.delay);
        } else {
          this.hide();
        }
  ...
  search(event, query2, source) {
    if (query2 === void 0 || query2 === null) {
      return;
    }
    if (source === "input" && query2.trim().length === 0) {
      return;
    }
    this.loading = true;
